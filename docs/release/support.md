...
- **A shared item saves before you can edit it:** on iPhone or iPad, turn off **Save shared items immediately** under Settings › Sharing to restore the Save to Stow confirmation screen.
