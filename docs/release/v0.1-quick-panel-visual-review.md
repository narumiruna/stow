...
- Review status: **Owner approved on 2026-08-09**
...
- [x] The owner approved the normal, compact, search, dirty-confirmation, error, light, dark, narrow, Copy-only, Direct Paste, paused-monitoring, Reduce Motion, and Increase Contrast presentations above on 2026-08-09.
